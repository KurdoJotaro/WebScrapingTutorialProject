...
if __name__ == "__main__":
    ...
    print("--- *** BKM KİTAP SCRAPER BAŞLATILDI *** ---")
    ...
    for sayfa_numarasi in range(1, 13):
        ...
        kitap_bu_sayfadan = scraper.scrape_bkm_kitap(url)

        if kitap_bu_sayfadan:
            tum_kitaplar.extend(kitap_bu_sayfadan)
